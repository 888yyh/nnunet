...
FilePath: \nnUNet-master\nnunet\experiment_planning\nnUNet_convert_decathlon_task.py
...
def main():
    ...
    parser.add_argument("-i", help="Input folder. Must point to a TaskXX_TASKNAME folder as downloaded from the MSD "
                                   "website", default='E:/nzl/nnunetbrats2020/nnUNet-master/nnUNet_raw_data_base/nnUNet_raw_data/Task05_Prostate',required=False)
